        ...
        <div class="col-lg-12">
            <div class="card border-success">
                <div class="card-header bg-info text-white">
                    <i class="fa fa-hotel fa-fw"></i> Crear Cirugia
                    ...
                    <div id="morris-area-chart">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {{ Form::open( array('url'=>'cirugias?ingreso='.$ingreso,'method'=>'post','class'=>'form-horizontal','id'=>'formCreate','name'=>'formCreate')) }}    
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        {{link_to('cirugias?ingreso='.$ingreso,'volver',array('class'=>'btn btn-info btn-xs'))}}
