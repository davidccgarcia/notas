        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-file-o"></i> Editar Nota de Enfermería
                    ...
                    <div id="morris-area-chart">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {{ Form::model($evolucion, array('url'=>'notas/'.$evolucion->hc_notas_enfermeria_descripcion_id,'method'=>'PATCH','class'=>'form-horizontal')) }}
                                ...
                                $fecha=  explode(" ", $evolucion->fecha_registro_nota);
