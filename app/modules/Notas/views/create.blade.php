        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-file-o"></i> Crear Nota
                    ...
                    <div id="morris-area-chart">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {{ Form::open( array('url'=>'notas?ingreso='.$ingreso,'method'=>'post','class'=>'form-horizontal','id'=>'formCreate','name'=>'formCreate')) }}
                                ...
                                <div class="form-group">
                                    {{ Form::label('fecha registro', 'Fecha registro',array('class'=>'col-sm-2 control-label')) }}
                                    <div class="col-sm-10">
                                        <input type="date" name="fecha_registro" id="fecha_registro" class="form-control" required>
                                    </div>
                                </div>
                                  <div class="form-group">
                                    {{ Form::label('fecha_registro_hora', 'Hora registro',array('class'=>'col-sm-2 control-label')) }}
                                    <div class="col-sm-10">
                                        <input type="time" name="fecha_registro_hora" id="fecha_registro_hora"  max="23:59" min="00:00" class="form-control" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        {{link_to('notas?ingreso='.$ingreso,'volver',array('class'=>'btn btn-info btn-xs'))}}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalUsuarioLabel">Buscar Usuario</h4>
            </div>
            <div class="modal-body">
                <form id="formulario">
                    <div class="form-group">

                        <input type="text" class="form-control" name="usuario_text" id="usuario_text" placeholder="Nombre del usuario">
                    </div>
                </form>
                <div id="resultado">
